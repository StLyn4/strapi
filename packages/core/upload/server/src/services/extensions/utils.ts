...
import type { Attribute, Common, EntityService } from '@strapi/types';
...
function isFile(value: unknown, attribute: Attribute.Any): value is File {
...
const signEntityMedia = async (
  entity: EntityService.Result<Common.UID.Schema>,
